...
const Footer = () => {
  return (
    <div>
      {/* <!--Footer Section--> */}
      <section className="bg-[#1A3129] p-5 lg:px-24 lg:py-10 flex flex-col gap-6">
        {/* <!--Upper nav type footer section--> */}
        <div className="flex flex-col lg:flex-row justify-between items-center gap-5">
          {/* <!--Logo--> */}
          <img
            src="./Assets/Logo/Nutritionist Logo.png"
            alt="Nutritionist"
            className="h-10 w-auto"
          />

          {/* <!--Nav Links--> */}
          <ul className="flex flex-wrap justify-center lg:justify-end gap-4 lg:gap-6 text-center">
            <li>
              <Link
                to="/"
                className="hover:text-green-400 transition hover:underline text-white"
              >
                Home
              </Link>
            </li>
          ...
          >
            <p className="text-white text-sm lg:text-base">Go To Top</p>
            <svg
              className="m-1 p-1 rounded-full cursor-pointer bg-[#234338]"
              width="34"
              height="34"
              viewBox="0 0 34 34"
              fill="none"
        ...
        <div className="bg-[#2C5446] flex flex-col lg:flex-row justify-between items-center gap-6 rounded-lg p-6 lg:p-10 text-center lg:text-left">
          {/* <!--Contact Info--> */}
          ...
          <div className="flex items-center gap-2">
            ...
            <p className="text-white text-sm lg:text-base">+91 91813 23 2309</p>
          </div>
          {/* <!--Location--> */}
